            ...
            <div className="col-4">
                <form>
                    ...
                    <div className="container row mt-4">
                        ...
                        <div className="col">
                            <a href="/RegistroUno" type="submit" className="btn btn-secondary form-control">Regresar</a>
                        </div>
                        <div className="col">
                            <a href="/ErrorRegistro" type="submit" className="btn btn-secondary form-control">Finalizar</a>
                        </div>
